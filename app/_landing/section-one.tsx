...
import GithubCardShiny from "@/mage-ui/card/github-card-shiny";
...
import MirrorText from "@/mage-ui/text/mirror-text";
import TypingText from "@/mage-ui/text/typing-text";
            ...
            <div className="flex flex-col rounded-xl border border-border bg-gray-100 dark:border-zinc-600 dark:bg-zinc-700 lg:col-span-2">
              ...
              <div className="group w-full p-4 font-mono text-sm">
                <div className="mt-2 line-clamp-1">
                  ...
                  &quot;@/mage-ui/text/bold-copy&quot;
                </div>

                <TypingText className="my-2 w-full" text='<BoldCopy text="mage-ui" />' />
              </div>
            </div>
          </ComponentCard>
        </div>
