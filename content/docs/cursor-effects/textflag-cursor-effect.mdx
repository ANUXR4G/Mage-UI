...
<ComponentPreview name="cursor-effects-textflag-cursor-effect--docs" />
...
It will create a new file `textflag-cursor-effect.tsx` inside the `components/mage-ui/cursor-effects` directory.
