...
<ComponentPreview name="cursor-effects-spotlight-cursor-effect--docs" />
...
It will create a new file `spotlight-cursor-effect.tsx` inside the `components/mage-ui/cursor-effects` directory.
