...
<ComponentPreview name="cursor-effects-glitch-cursor-effect--docs" />
...
It will create a new file `glitch-cursor-effect.tsx` inside the `components/mage-ui/cursor-effects` directory.
