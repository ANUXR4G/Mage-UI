...
<ComponentPreview name="cursor-effects-neon-cursor-effect--docs" />
...
It will create a new file `neon-cursor-effect.tsx` inside the `components/mage-ui/cursor-effects` directory.

```bash 
mkdir -p components/mage-ui/cursor-effects && touch components/mage-ui/cursor-effects/neon-cursor-effect.tsx
```
