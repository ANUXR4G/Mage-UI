...
<ComponentPreview name="cursor-effects-trail-cursor-effect--docs" />
...
```bash 
mkdir -p components/mage-ui/cursor-effects && touch components/mage-ui/cursor-effects/trail-cursor-effect.tsx
```
