...
<ComponentPreview name="cursor-effects-springy-cursor-effect--docs" />
...
It will create a new file `springy-cursor-effect.tsx` inside the `components/mage-ui/cursor-effects` directory.
