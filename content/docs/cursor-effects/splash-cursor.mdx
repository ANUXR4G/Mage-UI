---
title: Splash Cursor
description: A splash cursor is a dynamic pointer animation that visually “splashes” or disperses particles upon clicking or hovering.
---

<ComponentPreview name="cursor-effects-splash-cursor--docs" />
...
```bash 
mkdir -p components/mage-ui/cursor-effects && touch components/mage-ui/cursor-effects/splash-cursor.tsx
```
