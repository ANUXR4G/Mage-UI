...
<ComponentPreview name="cursor-effects-follow-cursor-effect--docs" />
...
It will create a new file `follow-cursor-effect.tsx` inside the `components/mage-ui/cursor-effects` directory.
