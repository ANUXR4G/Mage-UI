...
<ComponentPreview name="preloader-sphere-animation--docs" />
...
It will create a new file `sphere-animation.tsx` inside the `components/mage-ui/preloader` directory.

```bash 
mkdir -p components/mage-ui/preloader && touch components/mage-ui/preloader/sphere-animation.tsx
```
