---
title: Loading Truck
description: A Truck Animation for Loader
---

<ComponentPreview name="preloader-loading-truck--docs" />
...
It will create a new file `loading-truck.tsx` inside the `components/mage-ui/preloader` directory.

```bash 
mkdir -p components/mage-ui/preloader && touch components/mage-ui/preloader/loading-truck.tsx
```
