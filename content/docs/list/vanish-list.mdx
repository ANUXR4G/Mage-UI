---
title: Vanish List
description: A vanish list is a UI effect where list items gradually disappear or animate out when removed, creating a smooth and dynamic user experience.
---

<ComponentPreview name="list-vanish-list--docs" />
...
It will create a new file `vanish-list.tsx` inside the `components/mage-ui/list` directory.

```bash 
mkdir -p components/mage-ui/list && touch components/mage-ui/list/vanish-list.tsx
```
