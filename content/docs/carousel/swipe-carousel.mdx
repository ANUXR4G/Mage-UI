...
description: A Swipe Carousel is a slider component that allows users to swipe through multiple items smoothly, often used for images or content navigation.
---

<ComponentPreview name="carousel-swipe-carousel--docs" />
...
It will create a new file `swipe-carousel.tsx` inside the `components/mage-ui/carousel` directory.
