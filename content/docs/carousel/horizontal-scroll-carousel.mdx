...
description: A Horizontal Scroll Carousel is a UI component that lets users scroll sideways to browse through multiple items seamlessly.
---

<ComponentPreview name="carousel-horizontal-scroll-carousel--docs" />
...
It will create a new file `horizontal-scroll-carousel.tsx` inside the `components/mage-ui/carousel` directory.
