---
title: Curved Loop
description: Text Curve Loop
author: anuxr4g

<ComponentPreview name="accordion-curved-loop--docs" />
...
It will create a new file `curved-loop.tsx` inside the `components/mage-ui/accordion` directory.

```bash 
mkdir -p components/mage-ui/accordion && touch components/mage-ui/accordion/curved-loop.tsx
```
