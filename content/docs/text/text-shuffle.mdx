---
title: Text Shuffle
description: Shuffle Effect On The Text
author: YourTwitterUsername
---

<ComponentPreview name="text-text-shuffle--docs" />
...
```bash 
mkdir -p components/mage-ui/text && touch components/mage-ui/text/text-shuffle.tsx
```
