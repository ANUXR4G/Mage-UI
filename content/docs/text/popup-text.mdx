---
title: Popup Text
description: Alphabets Will PopUp One by One
author: YourTwitterUsername
---

<ComponentPreview name="text-popup-text--docs" />
...
It will create a new file `popup-text.tsx` inside the `components/mage-ui/text` directory.

```bash 
mkdir -p components/mage-ui/text && touch components/mage-ui/text/popup-text.tsx
```
