---
title: Drag Close Drawer
description: A drag-close drawer is a UI component that allows users to swipe or drag to close a sliding panel, enhancing mobile and touch-friendly interactions.
---

<ComponentPreview name="overlay-drag-close-drawer--docs" />
...
It will create a new file `drag-close-drawer.tsx` inside the `components/mage-ui/overlay` directory.

```bash 
mkdir -p components/mage-ui/overlay && touch components/mage-ui/overlay/drag-close-drawer.tsx
```
