...
<ComponentPreview name="button-shiny-button--docs" />
...
It will create a new file `shiny-button.tsx` inside the `components/mage-ui/button` directory.

```bash 
mkdir -p components/mage-ui/button && touch components/mage-ui/button/shiny-button.tsx
```
