...
<ComponentPreview name="button-interactive-hover-button--docs" />
...
It will create a new file `interactive-hover-button.tsx` inside the `components/mage-ui/button` directory.

```bash 
mkdir -p components/mage-ui/button && touch components/mage-ui/button/interactive-hover-button.tsx
```
