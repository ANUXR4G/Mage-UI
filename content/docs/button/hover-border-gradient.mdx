...
<ComponentPreview name="button-hover-border-gradient--docs" />
...
It will create a new file `hover-border-gradient.tsx` inside the `components/mage-ui/button` directory.
...
```jsx file=<rootDir>/mage-ui/button/hover-border-gradient.tsx
