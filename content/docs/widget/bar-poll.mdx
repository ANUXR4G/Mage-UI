---
title: Bar Poll
description: A bar poll is a visual representation of poll results using horizontal or vertical bars to indicate the percentage of votes for each option.
author: YourTwitterUsername
---

<ComponentPreview name="widget-bar-poll--docs" />
...
It will create a new file `bar-poll.tsx` inside the `components/mage-ui/widget` directory.
