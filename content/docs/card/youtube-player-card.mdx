---
title: Youtube Player Card
description: A collection of YouTube video player examples showcasing different configurations and styling options.
---

<ComponentPreview name="card-youtube-player-card--docs" />
...
It will create a new file `youtube-player-card.tsx` inside the `components/mage-ui/card` directory.
