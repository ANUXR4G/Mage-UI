---
title: Drag Cards
description: Drag Cards are movable UI elements that users can click and drag to rearrange or interact with content.
---

<ComponentPreview name="card-drag-cards--docs" />
...
It will create a new file `drag-cards.tsx` inside the `components/mage-ui/card` directory.

```bash 
mkdir -p components/mage-ui/card && touch components/mage-ui/card/drag-cards.tsx
```
